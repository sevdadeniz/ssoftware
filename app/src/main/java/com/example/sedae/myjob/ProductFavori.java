...
public class ProductFavori {
    ...
    public ProductFavori() {
    }

    public ProductFavori(int imageID, int kullaniciImage, int setImage, int likeButon, int messageButton, String kullaniciAdi, String ilanAdi, String ilanAciklama) {
    ...
    public static ArrayList<ProductFavori> getData() {
        ArrayList<ProductFavori> productList = new ArrayList<ProductFavori>();
        ...
        String[] kullaniciAdi = {"KullanıcıAdi", "Kulanıcı Adı", "Kullanıcı"};
        ...
        for (int i = 0; i < kullaniciImages.length; i++) {
            ProductFavori temp = new ProductFavori();
